...
public class MyQueueCyclic<E> implements MyQueue<E>{
    ...
    public void enqueue( E x ) throws FullException{
        if(isFull()){
            ...
            array.set(write,x);
            //array.add(write,x); add(index,val) - dodaje element na koniec jezeli index jest wiekszy od rozmiaru, lub umieszcza w odpowiedniej pozycji jezeli taki index istnieje
